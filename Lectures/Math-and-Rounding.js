...
// THE REMAINDER OPERATOR IS VERY USEFUL , WE CAN GET VALUES ACCORDING TO OUR REMAINDER THAT WE WANT TO GET .
console.log(8 % 3);
console.log(8 / 3); // 8 = 2 * 3 + 2 .

console.log(6 % 2); // 6 = 2 * 2 + 0 .

// WE CAN CREATE A FUNCTION , TO CHECK IF THE VALUE IS EVEN OR ODD.
const evenOdd = (num) => {
  if (num % 2 === 0) {
...
// THERE IS ANOTHER USE CASE FOR REMAINDER OPERATOR , IN BANKIST APP PROJECT , WE GET THE ROWS OF MOVEMENTS AND APPLIED A FUNCTION , TO CHANGE THE BACKGROUND COLOR OF EACH EVEN ROW , AND CHANGE THE BACKGROUND COLOR FOR EACH ROW DIVISIBLE BY 3 .
